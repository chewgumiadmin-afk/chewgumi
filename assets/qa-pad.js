...
(function () {
  ...
  css.textContent = [
    ...
    '  margin-top:7px;align-items:stretch}',
    '.cgp-t button{height:34px;min-height:34px;border:0;border-radius:8px;cursor:pointer;',
    '  background:rgba(255,255,255,.72);font-family:inherit;font-size:10.5px;',
    '  font-weight:600;color:#5a4f2a;padding:0 4px;white-space:nowrap;',
