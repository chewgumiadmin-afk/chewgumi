...
(function () {
  ...
  var DICT = {
    ...
    /* 결제 확인 화면 (pay-return) — 결제를 마친 손님이 보는 마지막 화면입니다.
       무통장·가상계좌는 여기서 계좌번호가 나오므로 영문 손님에게 특히 중요합니다. */
    '결제를 확인하고 있습니다': 'Confirming your payment',
    '창을 닫지 마시고 잠시만 기다려 주세요.': 'Please keep this window open for a moment.',
    '결제가 완료되었습니다': 'Payment complete',
    '주문이 정상 접수되었습니다. 곧 발송해 드릴게요.': 'Your order is confirmed. We will ship it shortly.',
    '주문해 주셔서 감사합니다. 곧 준비해 보내드리겠습니다.': 'Thank you for your order. We will prepare and send it shortly.',
    '결제가 완료되지 않았습니다': 'Payment was not completed',
    '결제에 실패했습니다': 'Payment failed',
    '결제 정보를 확인할 수 없습니다': 'We could not find your payment details',
    '다시 시도해 주세요.': 'Please try again.',
    '주문 내역에서 상태를 확인해 주세요.': 'Please check the status in your order history.',
    '확인하지 못했습니다': 'We could not confirm it',
    '잠시 후 주문 내역에서 다시 확인해 주세요.': 'Please check again in your order history in a moment.',
    '입금을 기다리고 있습니다': 'Waiting for your deposit',
    '아래 계좌로 입금해 주시면 배송이 시작됩니다.': 'Send your payment to the account below and we will start shipping.',
    '입금 계좌': 'Deposit account',
    '은행': 'Bank',
    '계좌번호': 'Account number',
    '예금주': 'Account holder',
    '입금기한': 'Payment due',
    '거래번호': 'Transaction number',
    '결제금액': 'Amount',
    '결제수단': 'Payment method',
    '다음으로 하실 수 있는 것': 'What you can do next',
    '주문번호로': 'by order number',
    '적립금 받기': 'get points',
    '발송 뒤': 'after dispatch',
